...
###  Part 1 Plot the 30-day mortality rates for heart attack ([outcome.R](https://github.com/swarnaravi/outcome.R))
...
outcome[, lapply(.SD
        ...
        , .SDcols = (11)]
```
![](https://github.com/swarnaravi/Hospital_30_day_death.png)
###  Part 2 Finding the best hospital in a state ([best.R](https://github.com/swarnaravi/projects/best.R))
```R
...
```
###  Part 3 Ranking hospitals by outcome in a state ([rankhospital.R](https://github.com/swarnaravvi/projects/rankhospital.R))
```R
...
```
###  Part 4 Ranking hospitals in all states ([rankall.R](https://github.com/swarnaravi/projects/rankall.R))
```R
